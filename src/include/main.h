...
//     CVarWrapper RegisterCvar_Number(const CvarData& cvar, float startingValue, bool hasMinMax = false, float min = 0, float max =
//     0); CVarWrapper RegisterCvar_Color(const CvarData& cvar, const std::string& startingValue); CVarWrapper GetCvar(const CvarData&
//     cvar);
//
