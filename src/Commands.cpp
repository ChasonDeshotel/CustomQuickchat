...
void
CustomQuickchat::cmd_listBindings(std::vector<std::string> args) {
...
void
CustomQuickchat::cmd_test(std::vector<std::string> args) {
...
void
CustomQuickchat::cmd_test2(std::vector<std::string> args) {
    // ...
}
