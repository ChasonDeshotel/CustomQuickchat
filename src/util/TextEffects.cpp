...
auto
splitIntoWords(const std::string& input) -> std::vector<std::string> {
...
auto
to_sarcasm(const std::string& ogText) -> std::string {
    std::istringstream iss(ogText);
    std::ostringstream oss;
    std::string word;
...
// uwu effect
auto
translateChar(char currentChar, char previousChar, char nextChar) -> std::string {
...
auto
translateWord(const std::string& input) -> std::string {
    std::string result;
...
auto
to_uwu(const std::string& ogText) -> std::string {
