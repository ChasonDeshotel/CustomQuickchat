...
void
CustomQuickchat::changed_enabled(std::string cvarName, CVarWrapper updatedCvar) {
    bool enabled = updatedCvar.getBoolValue();

    std::string msg = "Custom quickchats turned " + std::string(enabled ? "ON" : "OFF");

    GAME_THREAD_EXECUTE_CAPTURE(Instances.SpawnNotification("Custom Quickchat", msg, 3);, msg);
}

void
CustomQuickchat::changed_enableSTTNotifications(std::string cvarName, CVarWrapper updatedCvar) {
...
void
CustomQuickchat::changed_overrideDefaultQuickchats(std::string cvarName, CVarWrapper updatedCvar) {
...
void
CustomQuickchat::changed_blockDefaultQuickchats(std::string cvarName, CVarWrapper updatedCvar) {
...
void
CustomQuickchat::changed_useCustomChatTimeoutMsg(std::string cvarName, CVarWrapper updatedCvar) {
...
void
CustomQuickchat::changed_customChatTimeoutMsg(std::string cvarName, CVarWrapper updatedCvar) {
