...
void CustomQuickchat::onLoad() {
    ...
    RegisterCommand(Commands::list_custom_chat_labels,
                    std::bind(&CustomQuickchat::cmd_list_custom_chat_labels, this, std::placeholders::_1));
    ...
    gameWrapper->HookEventWithCaller<ActorWrapper>(Events::GFxHUD_TA_ChatPreset,
                                                   std::bind(&CustomQuickchat::Event_GFxHUD_TA_ChatPreset, this, std::placeholders::_1,
                                                             std::placeholders::_2, std::placeholders::_3));

    gameWrapper->HookEventWithCallerPost<ActorWrapper>(Events::ApplyChatSpamFilter,
                                                       std::bind(&CustomQuickchat::Event_ApplyChatSpamFilter, this,
                                                                 std::placeholders::_1, std::placeholders::_2, std::placeholders::_3));

    gameWrapper->HookEventWithCaller<ActorWrapper>(Events::GFxHUD_TA_NotifyChatDisabled,
                                                   std::bind(&CustomQuickchat::Event_NotifyChatDisabled, this, std::placeholders::_1,
                                                             std::placeholders::_2, std::placeholders::_3));
    ...
    gameWrapper->HookEventPost(Events::MatchEnded, [this](std::string eventName) {
        matchEnded = true;
    });
    gameWrapper->HookEventPost(Events::EnterStartState, [this](std::string eventName) {
        inGameEvent = true;
    });
    ...
    gameWrapper->HookEventWithCaller<ActorWrapper>(Events::OnPressChatPreset,
                                                   std::bind(&CustomQuickchat::Event_OnPressChatPreset, this, std::placeholders::_1,
                                                             std::placeholders::_2, std::placeholders::_3));
