...
void
CustomQuickchat::Event_GFxHUD_TA_ChatPreset(ActorWrapper caller, void* params, std::string eventName) {
...
void
CustomQuickchat::Event_ApplyChatSpamFilter(ActorWrapper caller, void* params, std::string eventName) {
...
void
CustomQuickchat::Event_NotifyChatDisabled(ActorWrapper caller, void* params, std::string eventName) {
    gamePaused = false;
...
void
CustomQuickchat::Event_LoadingScreenStart(std::string eventName) {
    gamePaused = false;
    matchEnded = false;
    inGameEvent = false;
